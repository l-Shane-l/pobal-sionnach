...
class GaeilgeKeyboardWidget extends ConsumerStatefulWidget {
  final Function(String) onLetterTap;
  final VoidCallback onBackspaceTap;
  final VoidCallback onShiftTap;

  const GaeilgeKeyboardWidget({
    super.key,
  ...
  @override
  ConsumerState<GaeilgeKeyboardWidget> createState() =>
      _CustomKeyboardWidgetState();
}

class _CustomKeyboardWidgetState extends ConsumerState<GaeilgeKeyboardWidget>
